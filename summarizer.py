"""Meeting summarization. Tries Azure OpenAI if credentials are present,
otherwise falls back to a simple extractive summarizer so the pipeline
still runs end-to-end without live credentials (useful for demo/testing)."""
